...
void searchbycode(struct Product prod[], int userChoice, int oldnumberOfProduct)
{
...
void searchbycodequantite(struct Product prod[], int userChoice, int oldnumberOfProduct)
{
	for (int i = 0; i < oldnumberOfProduct; i++)
	{
...
void buyProduct()
{
	printf("\nWRITE THE MUMBER OF THE PRODUCT\n");
	scanf("%d", &p);
...
int main()
{
	...
	switch (userChoice)
	{
		...
		case 55:
			...
			{
				case 1:
					printf("WRITE THE QUAN OF THE PRODUCT WHAT ARE YOU LOKING FOR\n");
					scanf("%d", &userChoice);
					searchbycodequantite(prod, userChoice, oldnumberOfProduct);
					break;
				case 2:
